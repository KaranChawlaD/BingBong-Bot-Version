...
#key dictonary
pressed_keys = {"Paddle1Up": False, "Paddle1Down": False}
...
while running:
    ...
    if not Paused and started:
        ...
        if paddlechange_2 < pingy:
            paddlechange_2 += abs(pingychange) - random.uniform(0.0, 0.05)
        if paddlechange_2 > pingy:
            paddlechange_2 -= abs(pingychange) - 0.1
